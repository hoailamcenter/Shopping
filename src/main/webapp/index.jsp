    ...
    <div class="row">
        ...
        <div class="col-12 col-md-3" >              	  	
            <div class="card" style="height: 100%;">            
                ...
                <div class="card-body">
                    <h4 class="card-title text-center"><a href="productdetail.jsp" title="View Product">${top1product.productName}</a></h4>
                    <div class="row">
                        <div class="col">
                            <p class="btn btn-danger btn-block">${top1product.price}</p>
                        </div>
                        <div class="col">
                            <a href="productdetail.jsp" class="btn btn-success btn-block">View</a>
                        </div>
                    </div>
                </div>                  
            </div>                  	
                    ...
                    <c:forEach items="${list4product}" var="o">
                        <div class="col-sm-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="productdetail.jsp" title="View Product">${o.productName}</a></h4>
